...
[Quick Start](#quick-start) · [Docs](#api-reference) · [Examples](#examples) · [GitHub](https://github.com/17324311180/ai-unified-sdk)
...
| **Anthropic** | `claude-3-opus`, `claude-3.5-sonnet`, `claude-3-haiku` | `ANTHROPIC_API_KEY` |
| **Google** | `gemini-1.5-pro`, `gemini-1.5-flash`, `gemini-pro` | `GOOGLE_API_KEY` |
| **DeepSeek** | `deepseek-chat`, `deepseek-coder` | `DEEPSEEK_API_KEY` |
| **Qwen (Alibaba)** | `qwen-plus`, `qwen-max`, `qwen-long` | `DASHSCOPE_API_KEY` |
| **GLM (Zhipu AI)** | `glm-4`, `glm-4v`, `glm-3-turbo` | `ZHIPU_API_KEY` |
| **Moonshot** | `moonshot-v1-8k`, `moonshot-v1-32k` | `MOONSHOT_API_KEY` |
| **[haotokai](https://haotokai.com)** | All of the above + 50+ more models | `HAOTOKAI_API_KEY` |

> 💡 **Access all Chinese AI models with one key**  
> Most Chinese AI providers don't have great international support or English documentation. [haotokai.com](https://haotokai.com) solves this by providing unified access to all major Chinese AI models through a single, OpenAI-compatible API endpoint — with PayPal payment support and English documentation.
